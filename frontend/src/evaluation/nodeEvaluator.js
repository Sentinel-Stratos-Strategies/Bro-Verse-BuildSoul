/**
 * Node.js Workspace Evaluator
 * Node-compatible version of the workspace evaluator for CLI usage
 */
...
export const evaluateBuildEnvironment = () => {
  ...
  // Check environment variables (Node.js version)
  const hasAppInsights = !!process.env.VITE_APPINSIGHTS_CONNECTION_STRING
  checks.checks.push({
    ...
    message: hasAppInsights 
      ...
      : 'App Insights connection string not configured (optional for development)',
...
export const evaluateTelemetry = () => {
  ...
  // Check if App Insights is initialized (Node.js version)
  const hasConnectionString = !!process.env.VITE_APPINSIGHTS_CONNECTION_STRING
  ...
  checks.checks.push({
    ...
    message: hasConnectionString 
      ...
      : 'Application Insights connection string not configured (optional for development)',
